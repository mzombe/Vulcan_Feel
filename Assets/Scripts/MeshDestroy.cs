...
public class MeshDestroy : MonoBehaviour
{
    ...
    public void AddEdge(int subMesh, PartMesh partMesh, Vector3 normal, Vector3 vertex1, Vector3 vertex2, Vector2 uv1, Vector2 uv2)
    {
        if (!edgeSet)
        {
            edgeSet = true;
    ...
    public class PartMesh
    {
        ...
        public List<List<int>> _Triangles = new List<List<int>>();
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            GameObject.layer = LayerMask.NameToLayer("WallParts");
